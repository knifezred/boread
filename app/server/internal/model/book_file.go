...
type BookFile struct {
	...
	SourceFormat   *string        `gorm:"column:source_format;size:16" json:"sourceFormat,omitempty"`
	SourceFileURL  *string        `gorm:"column:source_file_url;size:512" json:"sourceFileUrl,omitempty"`
	ContentPath    *string        `gorm:"column:content_path;size:512" json:"contentPath,omitempty"`
	ContentSize    uint64         `gorm:"column:content_size;not null;default:0" json:"contentSize"`
	ContentMD5     *string        `gorm:"column:content_md5;size:32" json:"contentMd5,omitempty"`
	...
	ParseMessage   *string        `gorm:"column:parse_message;size:512" json:"parseMessage,omitempty"`
}
...
type BookUpload struct {
	BaseModel
	BookID       *uint64     `gorm:"column:book_id" json:"bookId,omitempty"`
	OriginalName string      `gorm:"column:original_name;size:255;not null" json:"originalName"`
	...
	FileMD5      *string     `gorm:"column:file_md5;size:32" json:"fileMd5,omitempty"`
	SourceFormat *string     `gorm:"column:source_format;size:16" json:"sourceFormat,omitempty"`
	ParseStatus  ParseStatus `gorm:"column:parse_status;type:char(1);not null;default:'1'" json:"parseStatus"`
	ParseMessage *string     `gorm:"column:parse_message;size:512" json:"parseMessage,omitempty"`
	ChapterCount *uint32     `gorm:"column:chapter_count" json:"chapterCount,omitempty"`
}
...
const (
	RuleScopeGlobal  RuleScopeType = "1" // 全局默认
	RuleScopeBook    RuleScopeType = "2" // 单书覆盖
)
...
type BookChapterRule struct {
	...
	ScopeType      RuleScopeType `gorm:"column:scope_type;type:char(1);not null;default:'1'" json:"scopeType"`
	BookID         *uint64       `gorm:"column:book_id" json:"bookId,omitempty"`
	Pattern        string        `gorm:"column:pattern;size:512;not null" json:"pattern"`
	TitleGroup     int           `gorm:"column:title_group;not null;default:0" json:"titleGroup"`
...
type BookContentFilterRule struct {
	...
	Category    *string           `gorm:"column:category;size:32" json:"category,omitempty"`
