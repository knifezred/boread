...
type SysMenu struct {
	...
	Component       *string      `gorm:"column:component;size:255" json:"component,omitempty"`
	...
	I18nKey         *string      `gorm:"column:i18n_key;size:255" json:"i18nKey,omitempty"`
	...
	Href            *string      `gorm:"column:href;size:255" json:"href,omitempty"`
	HideInMenu      bool         `gorm:"column:hide_in_menu;default:0" json:"hideInMenu"`
	ActiveMenu      *string      `gorm:"column:active_menu;size:128" json:"activeMenu,omitempty"`
	MultiTab        bool         `gorm:"column:multi_tab;default:0" json:"multiTab"`
	FixedIndexInTab *int         `gorm:"column:fixed_index_in_tab" json:"fixedIndexInTab,omitempty"`
	Query           JSONMap      `gorm:"column:query;type:json" json:"query,omitempty"`
