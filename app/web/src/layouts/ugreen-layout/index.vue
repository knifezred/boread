...
const { secondLevelMenus, childLevelMenus, isActiveFirstLevelMenuHasChildren } =
  provideMixMenuContext();

const GlobalMenu = defineAsyncComponent(
  () => import("../modules/global-menu/index.vue"),
);
...
function getSiderAndCollapsedWidth(isCollapsed: boolean) {
  ...
  if (
    isVerticalHybridHeaderFirst.value &&
    !isActiveFirstLevelMenuHasChildren.value
  ) {
    return 0;
  }
