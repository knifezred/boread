const local: App.I18n.Schema = {
  ...
  page: {
    ...
    home: {
      greeting: 'Welcome back, {userName}, a good day for reading!',
      weatherDesc: '{newBooks} new books added to your library, come explore!',
      totalBooks: 'Total Books',
      totalWordCount: 'Total Word Count',
      totalReadingWordCount: 'Total Reading Word Count',
      tagCount: 'Tags',
      totalChapters: 'Total Chapters',
      totalReadingHours: 'Total Reading',
      readingUnit: ' hrs',
      ...
      totalSessions: 'Reading Sessions',
      categoryDist: 'Category Distribution',
      readingTimeTop: 'Reading Time TOP 5',
      tagDist: 'Tag Distribution',
      recentActivity: {
        title: 'Recent Activity',
        moreNews: 'More',
        desc1: 'New book "Sword Comes" imported',
        desc2: 'New category "Fantasy" added',
        desc3: 'Added tags "Cthulhu" "Steampunk" to "Lord of Mysteries"',
        desc4: 'New character "Chen Ping\'an" added to "Sword Comes"',
        desc5: 'Updated chapter info of "Da Feng Da Geng Ren"',
        desc6: 'New category "Mystery" added',
        desc7: 'Added tags "Cultivation" to "A Record of a Mortal\'s Journey to Immortality"',
        desc8: 'New book "The Three-Body Problem" imported'
      },
      recentImports: 'Recent Imports',
      authorCount: 'Authors',
      wordCountDist: 'Word Count',
      short: 'Short',
      medium: 'Medium',
      long: 'Long',
      ...
      goEdit: 'Edit',
      missingIntro: 'Missing Intro',
      missingCategory: 'Missing Category',
      missingTags: 'Missing Tags',
      randomRecommend: 'Random Recommendations',
      refresh: 'Refresh',
      recommendReason: 'Reason',
      ratingDist: 'Ratings & Favorites',
      rating: 'Rating',
      favorites: 'Favorites',
      readingByCategory: 'Reading by Category',
      readingByTag: 'Reading by Tag',
      delete: 'Delete',
      activity: {
        newBook: 'New Book',
        editBook: 'Edit Book',
